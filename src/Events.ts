...
export interface BotEvent extends EventEmitter {
  ...
  emit(Event: "onGroupMemberHonorChange", msg: data.GroupMemberHonorChange): any
  emit(Event: "onGroupMemberTitleChange", msg: data.GroupMemberTitleChange): any
  ...
  on(Event: "onGroupMemberAdd", listener: (msg: data.GroupMemberAdd) => void): any
  on(Event: "onGroupMemberDecrease", listener: (msg: data.GroupMemberDecrease) => void): any
  ...
  on(Event: "onGroupMemberHonorChange", listener: (msg: data.GroupMemberHonorChange) => void): any
  on(Event: "onGroupMemberTitleChange", listener: (msg: data.GroupMemberTitleChange) => void): any
  ...
  addListener(Event: "onGroupMemberAdd", listener: (msg: data.GroupMemberAdd) => void): this
  addListener(Event: "onGroupMemberDecrease", listener: (msg: data.GroupMemberDecrease) => void): this
  ...
  addListener(Event: "onGroupMemberHonorChange", listener: (msg: data.GroupMemberHonorChange) => void): this
  addListener(Event: "onGroupMemberTitleChange", listener: (msg: data.GroupMemberTitleChange) => void): this
  ...
  once(Event: "onGroupMemberAdd", listener: (msg: data.GroupMemberAdd) => void): any
  once(Event: "onGroupMemberDecrease", listener: (msg: data.GroupMemberDecrease) => void): any
  ...
  once(Event: "onGroupMemberHonorChange", listener: (msg: data.GroupMemberHonorChange) => void): any
  once(Event: "onGroupMemberTitleChange", listener: (msg: data.GroupMemberTitleChange) => void): any
